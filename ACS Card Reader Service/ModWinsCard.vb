...
#Region "Miscellaneous"
  ...
  Public Shared Function GetScardStateMsg(ByVal Context As Long) As String
    Select Case Context
      Case SCARD_STATE_ATRMATCH
        Return ("This implies that the card in the reader is allocated for exclusive use by another application. If this bit is set, SCARD_STATE_PRESENT will also be set.")
      Case SCARD_STATE_CHANGED
        Return ("This implies that the given reader name is not recognized by the Service Manager. If this bit is set, then SCARD_STATE_CHANGED and SCARD_STATE_IGNORE will also be set.")
      Case SCARD_STATE_EMPTY
        Return ("This implies that there is a card in the reader.")
      Case SCARD_STATE_EXCLUSIVE
        Return ("This implies that the card in the reader is in use by one or more other applications, but may be connected to in shared mode. If this bit is set, SCARD_STATE_PRESENT will also be set.")
      Case SCARD_STATE_IGNORE
        Return ("This implies that there is a difference between the state believed by the application, and the state known by the Service Manager.When this bit is set, the application may assume a significant state change has occurred on this reader.")
      Case SCARD_STATE_INUSE
        Return ("This implies that the card in the reader is unresponsive or not supported by the reader or software.")
      Case SCARD_STATE_MUTE
        Return ("This implies that the card in the reader has not been powered up.")
      Case SCARD_STATE_PRESENT
        Return ("This implies that there is a card in the reader with an ATR matching one of the target cards. If this bit is set, SCARD_STATE_PRESENT will also be set. This bit is only returned on the SCardLocateCard() service.")
      Case SCARD_STATE_UNAVAILABLE
        Return ("This implies that there is not card in the reader. If this bit is set, all the following bits will be clear.")
      Case SCARD_STATE_UNAWARE
        Return ("The application requested that this reader be ignored. No other bits will be set.")
      Case SCARD_STATE_UNKNOWN
        Return ("The application requested that this reader be ignored. No other bits will be set.")
      Case SCARD_STATE_UNPOWERED
        Return ("This application is not willing to share this card with other applications.")
      Case Else
        Return "Unknown State (" & Context.ToString & ")!"
    End Select
  End Function
